...
declare const CustomDropdown: FC<Props$8>;
...
declare const CustomError: FC<Props$7>;
...
declare const CustomModal: FC<Props$6>;
...
declare const CustomMultiDropdown: FC<Props$5>;

type Props$4 = {
    isEnabled: boolean;
    toggleSwitch: () => void;
};
declare const CustomSwitchButton: FC<Props$4>;
...
declare const CustomSelect: FC<Props$3>;
...
declare const ModalContent: ({ onPress, title, subtitle, icon, buttonTitle, secondButton, secondButtonTitle, subTitleMarginBottom, subTitleWidth, marginHorizontal, secondButtonOnPress, isRowButton, loading }: Props$2) => React$1.JSX.Element;
...
declare const EmptyList: FC<Props$1>;

type Props = {
    uri: string;
    onClose: () => void;
};
declare const PaymentModal: FC<Props>;
