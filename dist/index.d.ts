...
type TransactionPINResponse = ApiResponse<any>;
...
type WasherAvailabiltyResponse = ApiResponse<{}>;
...
declare enum WithdrawalTransactionType {
    PAYMENT = "payment",
...
type TransactionResponse = ApiResponse<{
...
interface IRatingUserProfile {
    image: string;
    lastName: string;
    firstName: string;
}
interface IRatingUserMetadata {
    os: string;
    device: string;
...
declare const withdrawalValidationSchema: Yup.ObjectSchema<{
    amount: string;
}, Yup.AnyObject, {
    amount: undefined;
}, "">;
...
declare function sanitizeAmount(value: string): number;
declare function formatWithCommas(value: string): string;
...
declare const useRouteNotification: () => void;

declare const usePushNotification: () => {
...
declare const ENDPOINT: {
    ...
    PROFILE: string;
    RATINGS: string;
    SET_TRANSACTION_PIN: string;
    UPDATE_TRANSACTION_PIN: string;
...
declare const useSocket: () => SocketContextType;
...
declare class WashService {
    ...
    WASHER_AVAILABILTY(data: IWasherAvailability): Promise<axios.AxiosResponse<any, any>>;
}
...
declare class ProfileService {
    ...
    BANKS(data: paginationType): Promise<axios.AxiosResponse<any, any>>;
    ...
    SET_TRANSACTION_PIN(data: SetPINData): Promise<axios.AxiosResponse<any, any>>;
    UPDATE_TRANSACTION_PIN(data: UpdatePINData): Promise<axios.AxiosResponse<any, any>>;
}
